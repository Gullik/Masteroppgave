...
#define NPART_MAX 5000000 /*Max no. of particles,each species per process*/
...
FILE *pot2Dclr,*pot2D,*efx,*efy, *efz,*frho,*idens,*edens, *bdens;
...
long int c0[S],c1[S],c2[S],c3[S],c4[S],c5[S];
...
double *sigma;
int colltypes[S];
double *ptemp11, *ptemp12, *ptemp13,*ptemp14, *ptemp15, *ptemp16,*ptemp17, *ptemp18, *ptemp19;
double *ptemp21, *ptemp22, *ptemp23,*ptemp24, *ptemp25, *ptemp26,*ptemp27, *ptemp28, *ptemp29;
double *ptemp31, *ptemp32, *ptemp33,*ptemp34, *ptemp35, *ptemp36,*ptemp37, *ptemp38, *ptemp39;
FILE *probes11, *probes12, *probes13,*probes14, *probes15, *probes16,*probes17, *probes18, *probes19;
FILE *probes21, *probes22, *probes23,*probes24, *probes25, *probes26,*probes27, *probes28, *probes29;
FILE *probes31, *probes32, *probes33,*probes34, *probes35, *probes36,*probes37, *probes38, *probes39;


FILE *potdistr;
double potdistrmax;
double potdistrmin;
//potpots should be odd - to have central bin at 0!
#define POTPOTS 101
int potdistrarray[POTPOTS];
