\section{Langmuir Oscillations}
	...
	The electron density, \(n_0\) and pressure \(p_0\) is initally homogenous.
 	...
 	See one of the books mentioned in \cref{sec:plasma} for a more thorough overview.
	...
	a new perturbation away from the equilibrium. This phenomen is called Langmuir
	oscillations.
	...
	of the quantity, \(q \ll\tilde q \tilde q\). So even though we may miss some processes
