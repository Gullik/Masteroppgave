    \begin{tikzpicture}[%
        ...
        \draw[*->, royalBlue] (U) -- (V) node[move, midway] {Restrict};
        \draw[*->, royalBlue] (V) -- (W) node[move, midway] {Restrict};
        \draw[*->, royalBlue] (W) -- (Vup) node[move, midway] {Prolongate};
        \draw[*->, royalBlue] (Vup) -- (Uup) node[move, midway] {Prolongate};
